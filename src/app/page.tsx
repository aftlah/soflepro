...
const channel = [
  ...
  {
    title: "VIP CODE STUDIO",
    image: "/images/vipstd.svg",
    link: "https://www.youtube.com/@vipcodestudio",
  },
  {
    title: "Programmer Zaman Now",
    image: "/images/pzn.svg",
    link: "https://www.youtube.com/@ProgrammerZamanNow",
  },
  {
    title: "Sumantri S",
    image: "/images/ch-django.svg",
    link: "https://www.youtube.com/@sumantris",
  },
];
      ...
      <section id="about" className="mt-[65px]">
        <div className="flex flex-col justify-center items-center gap-y-[23px]">
          ...
          <p className="text-center md:max-w-lg">
            ...
            langkah. Sumber materi kami berasal dari channel-channel youtube
            yang sangat direkomendasikan bagi pemula.
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-col justify-center items-center gap-y-[23px]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-[20px]">
            {channel.map((channel, index) => (
              <div key={index} className="flex justify-center items-center hover:scale-90 transition duration-300 ease-in-out">
                <Link
                  href={channel.link}
                  target="_blank"
